...
public class BytesUtil2 {
	 ...
	 * @return 目标字节数组
	 * */
	public static byte[] subBytes(int byteArrLen, 
	 ...
	 * @return 目标字节数组
	 * */
	public static int subBytes2Int(int byteArrLen, 
			AtomicInteger dataSubStart, byte[] sourceByte) {
	 ...
	 * @return 目标字节数组
	 * */
	public static String subBytes2String(int byteArrLen, 
			AtomicInteger dataSubStart, byte[] sourceByte) {
		byte[] bytes = subBytes(byteArrLen,dataSubStart,sourceByte);
	 ...
	 * @return 目标字节数组
	 * */
	public static String subBytes2Substring(int byteArrLen, 
			AtomicInteger dataSubStart, byte[] sourceByte) {
		byte[] bytes = subBytes(byteArrLen,dataSubStart,sourceByte);
		String prop = "";
		try {
	...
	public static byte[] longToByteArray(long res) {
		byte[] targets = new byte[4]; 
