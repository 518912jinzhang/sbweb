        ...
        _bindAdd: function(b) {
            b.click(function() {
                $.fallr("show", {
                    buttons: {
                        button1: {
                            ...
                            onclick: function() {
                                ...
                                // = b.children("#modulename").text(),
								e = $(this).find("select option:selected").text(),
                                //d = b.children("#modulekey").val(),
                                d = b.children("#modulename").val(),
                    ...
                    content: '<form style="margin-left:20px"><p>\u6a21\u5757\u540d\uff1a</p>'+
						'<select id="modulename">'+
						'<option value="divChart1">\u8bbe\u5907\u5728\u7ebf\u7edf\u8ba1</option>'+
						'<option value="divChart2">\u6545\u969c\u5206\u6790\u7edf\u8ba1</option>'+
						'<option value="divChart3">\u7ec8\u7aef\u5728\u7ebf\u5206\u6790\u7edf\u8ba1</option>'+
						'<option value="divChart4">\u4e61\u9547\u6392\u540d</option>'+
						'<option value="divMap">\u5730\u56fe</option>'+
						'<option value="divTable1">\u6545\u969c\u5217\u8868</option>'+
						'<option value="divTable2">\u7535\u5b50\u4fe1\u606f\u91c7\u96c6</option>'+
						'<option value="divTable3">\u91cd\u70b9\u573a\u6240\u8fd0\u884c\u76d1\u63a7</option>'+
						'<option value="divTable4">\u91cd\u8981\u76ee\u6807\u91c7\u96c6</option>'+
						'</select>'+
						'<br/>'+
						'<p style="margin-top:15px">\u6a21\u5757\u4f4d\u7f6e\uff1a</p>\u5de6:<input type="radio" name="modulelayout" checked="checked" value="left"/>&nbsp&nbsp\u4e2d:<input type="radio" name="modulelayout" value="center"/>&nbsp&nbsp\u53f3:<input type="radio" name="modulelayout" value="right"/></form>',
                    icon: "add",
                    position: "center"
                })
            })
...
Jh.Portal = function(a) {
    ...
    return a = {
        ...
        _createItemContent: function() {
            var a = $(i);
            $("<ul style='width:250px;'><li>模块内容</li></ul>").appendTo(a);
            return a
        },
