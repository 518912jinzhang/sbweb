...
$(function(){
	...
	var hgt = window.screen.height-576-4;
	var wth = window.screen.width-305-4;
	wth = (wth/4);
	$("#divChart1,#divChart2,#divChart3,#divChart4").css("height", hgt+"px");
	$("#divChart1,#divChart2,#divChart3,#divChart4").css("width", wth+"px");
	$("#divChart1").css("left", "1px");
	$("#divChart2").css("left", (wth+3)+"px");
	$("#divChart3").css("left", (wth*2+5)+"px");
	$("#divChart4").css("left", (wth*3+7)+"px");
	$("#map_demo").css("width", (window.screen.width-4)+"px");
	$("#map_demo").css("height", "573px");
	$("#map_demo").css("left", "1px");
	$("#map_demo").css("top", "2px");

	//切换采集信息
	$("#tblPanelControl").click(function(){
		var tbl = $(this).val();
		$("#divTable2,#divTable3,#divTable4").hide();
		$("#"+tbl).show();
	});
